...
const addresses = [
  ...
  },
  {
    ...
    state: "Karnataka",
    phone: 5564345208,
    email: "stephiefangirl@gmail.com",
  },
];
...
function Checkout() {
  return (
    <>
      <div className=" mx-8 my-8 max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-600">
                    {" "}
                    Choose a existing permanent address to receive item
                  </p>
                  <ul role="list">
                    {addresses.map((address) => (
                      <li key={address.email} className="flex justify-between gap-x-6 py-5 px-2">
                        ...
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                          <p className="text-sm leading-6 text-gray-900">h</p>
                          <p className="text-sm leading-6 text-gray-900">{address.phone}</p>
                          <p className="text-sm leading-6 text-gray-700">{address.email}</p>
                        </div>
                      </li>
                    ))}
                  </ul>
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto bg-white mt-8 max-w-6xl px-0 sm:px-0 lg:px-0">
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                <h2 className="text-2xl mb-4 font-semibold tracking-tight text-gray-900">Cart</h2>
