                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div key={product.id} className="group relative p-2 border-solid border-[1px] border-gray-300 rounded-md">
                                ...
                                <div className="mt-4 flex justify-between">
                                  ...
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm line-through font-medium text-gray-400">
                                      {product.price}$
                                    </p>
                                  </div>
                                </div>
